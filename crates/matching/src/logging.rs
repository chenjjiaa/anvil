...
//! Logging initialization for Matching Engine service
//!
...
//!   - Can be set per module: `RUST_LOG=anvil_matching=debug,tonic=info`
//!
...
//! - Filename: `{component}.{date}.log` format (e.g., `matching.2026-01-10.log`)
...
fn setup_file_logging(log_dir: &Path) -> Result<non_blocking::NonBlocking> {
	...
	// - prefix: component name (e.g., "matching")
	// - suffix: ".log"
	// - rotation: daily
	// This creates files like "matching.2026-01-10.log"
